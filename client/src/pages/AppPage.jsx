  ...
  return (
    <div className="min-h-screen app-bg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
        <PageHeader config={config} selectedCat={selectedCat} historyCount={history.length} />
        <Toast message={copyMessage} />

        {!selectedCat && (
          <HomeDashboard
            config={config}
            exportStatus={exportStatus}
            skuToDecode={skuToDecode}
            decodeData={decodeData}
            decodeError={decodeError}
            onStart={resetProductFlow}
            onDecode={handleDecode}
            onDecodeInputChange={handleDecodeInputChange}
          />
        )}
        ...
        {selectedCat && !previewData && (
          <ProductBuilder
            ...
            isLivePriceLoading={isLivePriceLoading}
            getVisibleOptionsForQuestion={getVisibleOptions}
        ...
        {previewData && (
          <PreviewResult
            ...
            onBackToParameters={handleBackToParameters}
        ...
        {!selectedCat && (
          <ExportTools
            exportFromSku={exportFromSku}
            setExportFromSku={setExportFromSku}
            exportToSku={exportToSku}
            setExportToSku={setExportToSku}
