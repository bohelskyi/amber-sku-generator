...
export const PERMISSION_PRESENTATION = Object.freeze({
  ...
  'products.price_change': ['Пряма зміна ціни', 'Зміна ціни чинного товару без черги запитів.'],
  ...
  'corrections.create': ['Створення запитів', 'Підготовка запитів на переоблік і зміну ціни.'],
  'corrections.price_override': ['Керування ціною запиту', 'Вибір ручної UAH або USD/г ціни у запиті.'],
