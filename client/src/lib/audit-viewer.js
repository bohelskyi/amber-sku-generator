export const AUDIT_DOMAINS = Object.freeze([
  ...
  ['price_export_snapshot', 'Експорт змін цін'],
...
const EVENT_LABELS = Object.freeze({
  ...
  'price_export_snapshot.created': 'Знімок змін цін створено',
  'price_export_snapshot.confirmed': 'Знімок змін цін підтверджено',
...
const SUBJECT_LABELS = Object.freeze({
  ...
  correction_request: 'Запит на виправлення', price_export_snapshot: 'Знімок змін цін', repricing_draft: 'Чернетка переоцінки',
...
const DETAIL_LABELS = Object.freeze({
  ...
  priceExportRevision: 'Ревізія експорту ціни', applicationMode: 'Спосіб застосування',
